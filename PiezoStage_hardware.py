...
class PiezoStageHW(HardwareComponent):
    ...
    def setup(self):
        ...
        self.settings.New('x_initial', dtype=float, unit='um', initial=0)
        self.settings.New('y_initial', dtype=float, unit='um', initial=0)
        self.settings.New('x_pos', dtype=float, unit='um', iniitial=0)
        self.settings.New('y_pos', dtype=float, unit='um', initial=0)
